...
function viewPriceListTable(){
  ...
  if(companyName=="NA" && categoryName=="NA" && subcategoryName == "NA" && pricelistType =="002"){
    if (confirm("Please enter any one field")) {
      $("#companynameInput").val("NA");
    } else {
    }
  }
...
database.ref('estimatebillnumber').once("value").then(function(snapshot) {
  billnum=parseInt(snapshot.val().billnumber);
  console.log(snapshot.val().billnumber+" snap");
});
function returnCustDetails() {
  ...
  $('#billnumberestimate').html("Bill : "+(new Date()).getFullYear()+""+billnum);
  billnum=billnum+1;
  database.ref('estimatebillnumber').set({
    billnumber:billnum
  });
...
function returnCurrentEstimateUnit() {
  $('#showunitsdiv').empty();
    ...
    $("#showunitsdiv").append('Case: <input id="case" type="text" placeholder="Case"/><br/> Box: <input id="box"  type="text" placeholder="Box"/><br/> Piece: <input id="piece" type="text" placeholder="Piece"/>');
  } else if (currentunitconfig == "Case-Packets") {
    ...
    $("#showunitsdiv").append('Bundle: <input id="bundle" type="text" placeholder="Bundle"/> <br/>Katta: <input id="katta" type="text" placeholder="Katta"/><br/>Box: <input id="box" type="text" placeholder="Box"/>');
  } else if (currentunitconfig == "Bundle-Boxes") {
    ...
    $("#showunitsdiv").append('Case: <input id="case" type="text" placeholder="Case"/><br/> Cent: <input id="cent" type="text" placeholder="Cent"/><br/> Katta: <input id="katta" type="text"  placeholder="Katta"/>');
  } else if (currentunitconfig == "Case-Tube") {
